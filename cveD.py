...
# References: [1] Optimal estimation of diffusion coefficients from single-particle trajectories. Vestergaard, et al PRE (2014)
...
def boxAv(x, boxSize):
	"""Downsamples x with boxSize points per bin"""
	N = x.size
...
def D2eta(D, R, T):
	"""Computes the viscosity of a fluid in Pa*s
	...
	Returns:
	eta: viscosity in Pa*s (multiply by 1000 for cP)
	"""
